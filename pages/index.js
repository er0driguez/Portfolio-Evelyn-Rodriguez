      ...
      <main className="bg-white px-10 md:px-20 lg:px-40 dark:bg-gray-900">
        <section className="min-h-screen">
          ...
          <div className=" text-center p-10">
            ...
            <p className=" text-md py-5 leading-8 text-gray-800 md:text-xl mx-auto dark:text-white"> Web tinkerer by day and curious bibliophile by night. See my qualifications below! Need some more lorem ipsum. The cake is a lie. </p>
